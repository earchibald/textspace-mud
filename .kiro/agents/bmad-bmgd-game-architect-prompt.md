...
3. **generate-project-context**: Create optimized project-context.md for AI agent consistency
4. **correct-course**: Course Correction Analysis (when implementation is off-track)
5. **party-mode**: Bring the whole team in to chat with other expert agents from the party
