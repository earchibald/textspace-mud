...
## Available Workflows
1. **DS or dev-story or fuzzy match on dev-story**: [DS] Execute Dev Story workflow (full BMM path with sprint-status)
2. **CR or code-review or fuzzy match on code-review**: [CR] Perform a thorough clean context code review (Highly Recommended, use fresh context and different LLM)
3. **PM or party-mode or fuzzy match on party-mode**: [PM] Bring the whole team in to chat with other expert agents from the party
