...
## Available Workflows
1. **TS or tech-spec or fuzzy match on tech-spec**: [TS] Architect a technical spec with implementation-ready stories (Required first step)
2. **QD or quick-dev or fuzzy match on quick-dev**: [QD] Implement the tech spec end-to-end solo (Core of Quick Flow)
